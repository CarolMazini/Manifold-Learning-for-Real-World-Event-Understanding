...
class PCB(nn.Module):
    ...
    def change_last(self,class_num):
        # self.classifier0 = self.model.classifier0[:-1]
        # self.classifier1 = self.model.classifier1[:-1]
        # self.classifier2 = self.model.classifier2[:-1]
        # self.classifier3 = self.model.classifier3[:-1]
        # self.model.classifier4 = self.model.classifier4[:-1]
        # self.model.classifier5 = self.model.classifier5[:-1]
        for i in range(self.part):
            name = 'classifier'+str(i)
            setattr(self, name, ClassBlock(2048, class_num, droprate=0.5, relu=False, bnorm=True, num_bottleneck=256))
        print(self.model)
